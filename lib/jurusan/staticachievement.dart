...
class StaticAchievementState extends State {
  ...
  _getResponseQuestionFromCloudFirestore() async {
    for(int i = 0; i < _listQuestion.length; i++){
      ...
      _firestore.collection('questionnaire').document('response').collection('achievement').document(_id_faculty).collection(_id_departement).where('id_question', isEqualTo: _listQuestion[i].id).getDocuments().then((value){
        if(value.documents.isNotEmpty){
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        'Berikut daftar statik capaian kompetensi untuk jurusan $_name_departement',
                        maxLines: 3,
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Align(
                            ...
                            child: FlatButton(
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => StaticDetailsPage(action: 20, id: _listQuestion[index].id, title: _listQuestion[index].title, number: index,)));
                              }, 
                              child: Text(
                                'Lihat Detail'
                              ),
